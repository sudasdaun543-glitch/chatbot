...
export async function getAIReply(
  ...
  const styleReminder = isRu
    ? "\n\n[ВАЖНО: Пиши как живой человек в мессенджере — коротко, с опечатками, без длинных монологов. Максимум 1-3 коротких предложения. Иногда одно слово или восклицание — это нормально.]"
